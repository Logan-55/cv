...
document.addEventListener("mousemove", function (e) {
  cursor.setAttribute("style", "top:".concat(e.pageY, "px; left:").concat(e.pageX, "px;"));
}); // const si0 = "#s__i--0";
...
var sidebarItems = document.querySelectorAll(".s__i");

for (i = 0; i < sidebarItems.length; i++) {
  //   sidebarIds.push(sidebarItems[i].id); // Rentre l'id de chaque item de la sidebar dans un tableau
  document.querySelector("#".concat(sidebarItems[i].id)).addEventListener("click", function (e) {
...
var test = document.querySelector("#test"); // const p0 = document.querySelector("#p--0");

var p1 = document.querySelector("#p--1"); // const p2 = document.querySelector("#p--2");
// const p3 = document.querySelector("#p--3");
// const si0 = document.querySelector("#s__i--0");

var si1 = document.querySelector("#s__i--1"); // const si2 = document.querySelector("#s__i--2");
